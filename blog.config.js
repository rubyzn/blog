...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '逸舟', // 您的昵称 例如 tangly1024 🔄  ❓
  BIO: process.env.NEXT_PUBLIC_BIO || '走出信息孤岛，探索更大的世界', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://blog.easea.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 信息, 写作, 思考', // 网站关键词 英文逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '怡海', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '走出信息孤岛，探索更大的世界。', // 站点描述，被notion中的页面描述覆盖
